...
<html lang="en">
    ...
    <body>
        ...
        <div class="Tillbaka">
            <a href="MainSida.php" target="self"> Startsida </a>
        </div>
        ...
        <table>
            ...
            $xml = file_get_contents("https://wwwlab.webug.se/examples/XML/scheduleservice/courses?programsearch=".urlencode($search));
            $dom = new DomDocument;
